...
public class 우리 extends Account {

	
	// 1. 필드
	private final String bankCode="05";

	// 2. 생성자
	public 우리() {
		// TODO Auto-generated constructor stub
	}
	public 우리(String accountNum, String password, String name,int balance) {
	...
	public void deposit(String account,int money ) {
		...
		int check = -1;
		ArrayList<Account> result = getInstance();
		// 계좌번호 확인
